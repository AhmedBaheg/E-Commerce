...
public class Validation {
    ...
    private final Pattern PATTERN_NAME = Pattern.compile("[\\u0600-\\u065F\\u066A-\\u06EF\\u06FA-\\u06FFa-zA-Z ]+[\\u0600-\\u065F\\u066A-\\u06EF\\u06FA-\\u06FFa-zA-Z-_ ]");

    public boolean validationFullName(String value, TextInputLayout layout) {
    ...
    public boolean validationPhoneNumber(String value, TextInputLayout layout) {
        if (TextUtils.isEmpty(value)) {
